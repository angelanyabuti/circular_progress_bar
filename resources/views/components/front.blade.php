...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('affan/css/dataTables.bootstrap4.min.css') }}">
...
<!-- All JavaScript Files -->
    ...
    <script src="{{ asset('affan/js/jquery.counterup.min.js') }}"></script>
    <script src="{{ asset('affan/js/jquery.countdown.min.js') }}"></script>
    <script src="{{ asset('affan/js/imagesloaded.pkgd.min.js') }}"></script>
    <script src="{{ asset('affan/js/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('affan/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('affan/js/dark-mode-switch.js') }}"></script>
    <script src="{{ asset('affan/js/ion.rangeSlider.min.js') }}"></script>
    <script src="{{ asset('affan/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('affan/js/active.js') }}"></script>
{{--    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAzSrin0xQkP4Xjc6wYVyGD5UT7Lz3IyNk&libraries=places&callback=initMap&channel=GMPSB_addressselection_v1_cABC" async defer></script>--}}
    ...
    <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper">
                <a href="{{ url('/') }}"> <img src="{{asset('slim-logo.png')}}" style="height: 80px !important;">
                </a>
            </div>
            <!-- Navbar Toggler -->
    ...
    <div class="offcanvas-body p-0">
        ...
        <!-- Sidenav Nav -->
            <ul class="sidenav-nav ps-0">
                <li><a href="{{ url('/') }}">
                        <svg class="bi bi-house-door" width="18" height="18" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <li><a href="{{ route('my.orders') }}">
                        <svg class="bi bi-gear" width="18" height="18" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="container px-0">
        ...
        <div class="footer-nav position-relative">
            <ul class="h-100 d-flex align-items-center justify-content-between ps-0">
                ...
                <li><a href="{{ route('shop.categories') }}">
                ...
                <li><a href="{{ route('special-deals') }}">
                        ...
                        </svg><span>Special Deals</span></a></li>
                <li><a href="{{ route('my.orders') }}">
