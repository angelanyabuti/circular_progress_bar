                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 d-flex  justify-content-end">
                            ...
                            <div class="btn-export">
                                <button  data-toggle="modal" data-target="#exampleModal" class="btn btn-primary ag-grid-export-btn waves-effect waves-float waves-light">New Category</button>
                            </div>
                        </div>
                    </div>
                </div>
