        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">My Riders</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <table class="table">
                        ...
                        @foreach($users as $item)
                            <tr>
                                ...
                                <td>{{ $item -> rider -> vehicle_registration }}</td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('rider.profile', $item->id) }}">
        ...
        <div class="modal-dialog">
            <form class="add-new-user modal-content pt-0">
                ...
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="basic-icon-default-fullname">National Id</label>
                        <input wire:model.defer="national_id" type="text" class="form-control" />
                        @error('national_id') <span class="text-danger error">{{ $message }}</span>@enderror
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="basic-icon-default-fullname">Vehicle Type</label>
                        <select class="form-control" wire:model="vehicle_type">
                            <option value="">Select Type</option>
                            @foreach($vTypes as $vtype)
                                <option value="{{ $vtype-> id}}">{{ $vtype -> vehicle_type }} ( base price {{ $vtype -> base_price }} /=) </option>
                            @endforeach
                        </select>
                        @error('vehicle_registration') <span class="text-danger error">{{ $message }}</span>@enderror
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="basic-icon-default-fullname">Vehicle Reg</label>
                        <input wire:model.defer="vehicle_registration" type="text" class="form-control" />
                        @error('vehicle_registration') <span class="text-danger error">{{ $message }}</span>@enderror
                    </div>
